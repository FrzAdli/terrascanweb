...
<html lang="en"> 
  ...
  <body class="main-layout"> 
    ...
    <div class="container pt-3">
      <p class="text-left fw-bold  monochrome-black my-2 fs-1">Form Permintaan</p>
    ...
    <div class="container">
        <div class="register-page align-items-center">
            <div class="form-register">
                <p class="fw-bold fs-4 text-dark">Ajukan Permintaan Ubah Produk</p>
                <form class="register-form mt-3" id="requestform" action="/makerequest" method="post">
                    @csrf
                    <?php $user = Session::get('user'); ?>
                    <label for="sellerName" class="fw-bold primary-90">Penjual</label><br>
                    <input type="hidden" value="{{ $user['sellerId'] }}" id="sellerId" name="sellerId">
                    <input type="text" class="mb-3 border border-dark bg-neutral-30" value="{{ $user['username'] }}" id="sellerName" name="sellerName" disabled required>

                    <label for="requestType" class="fw-bold primary-90">Permintaan</label><br>
                    <select class="form-select mb-3 border border-dark" id="requestType" name="requestType" form="requestform" required>
                    ...
                    <label for="productId" class="fw-bold primary-90">Produk</label><br>
                    <select class="form-select mb-3 border border-dark" id="productId" name="productId" form="requestform" required>
                    ...
                    <label for="detail" class="fw-bold primary-90">Detail</label><br>
                    <input type="text" class="mb-3 border border-dark" placeholder="Masukkan detail perubahan" id="detail" name="detail">
                    ...
                    <button class="btn bg-primary-90 text-white my-4" type="submit" form="requestform">Submit</button>
                </form>
            </div>
        </div>
    </div>
