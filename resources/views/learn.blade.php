...
<html lang="en"> 
  ...
  <body class="main-layout"> 
    ...
    <!-- Learn section -->
    <div class="container bg-neutral-30 mt-3 p-5 rounded">
        <h1 class="fw-bold text-dark">Tanah Humus</h1>
        <div class="row">
          <div class="col-2 d-flex align-items-start">
            <div class="text-center ">
                <img src="{{ asset('assets/images/learnHumus.jpg') }}" class="img-fluid rounded" alt="">
            </div>
          </div>
    ...
    <div class="container bg-neutral-30 mt-3 mb-3 p-5 rounded">
        <h1 class="fw-bold text-dark">Tanah Vulkanik</h1>
        <div class="row">
          <div class="col-2 d-flex align-items-start">
            <div class="text-center ">
                <img src="{{ asset('assets/images/learnVulkanik.jpg') }}" class="img-fluid rounded" alt="">
            </div>
          </div>
          <div class="col-10 d-flex align-items-start">
            <p class="text-dark fs-5">
                Tanah vulkanik adalah tanah yang terbentuk dari lapukan material cair maupun padat yang keluar dari letusan gunung berapi.  
                Tanah vulkanik mengandung unsur hara yang sangat tinggi, sehingga tanah vulkanik cocok digunakan untuk kegiatan agraris atau pertanian. 
                Tanah vulkanik dapat kamu jumpai pada wilayah sekitar lereng gunung berapi.
                <br>
                <br>
                Tanah vulkanik muncul ketika terjadi letusan gunung berapi. Letusan tersebut memuntahkan aneka material yang sangat panas ke udara. 
                Salah satunya adalah abu vulkanik. Ketika keluar dari perut gunung. abu vulkanik tersebut sangat panas dan pekat yang dapat membahayakan. 
                Namun, ketika suhu abu vulkanik sudah dingin, abu yang melapisi permukaan tanah bisa meningkatkan kesuburan tanah.
            </p>
          </div>
        </div>
    </div>
