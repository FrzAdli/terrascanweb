...
<html lang="en"> 
  ...
  <body class="main-layout"> 
    ...
    <div class="container pt-3">
      <p class="text-left fw-bold  monochrome-black my-2 fs-1">Tentang Kami</p>
      <p class="text-left fw-bold primary-90 my-2 mt-3 fs-6">Grow Green, Live Vibrant!</p>
    </div>

    <!-- About section -->
    <section class="about_section layout_padding container">
      <div class="container  ">
        <div class="row border border-dark">
          <div class="col-2 d-flex align-items-start">
            <div class="img-fluid text-center">
                <img src="{{ asset('assets/images/TerraScanTrans.png') }}" alt="">
            </div>
          </div>
          <div class="col-10 d-flex align-items-start">
            <p class="m-3 fs-5">
                <span class="primary-90 fw-bold">TerraScan</span> adalah revolusi terbaru dalam dunia pertanian dan pengelolaan lahan, menghadirkan kecerdasan buatan yang canggih untuk menganalisis jenis tanah dengan lebih akurat dan efisien melalui gambar. Produk unggulan ini dikembangkan untuk memenuhi kebutuhan para petani, insinyur pertanian, ilmuwan tanah, dan pengelola lahan dalam mengidentifikasi dan memahami karakteristik tanah dengan tepat
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container mb-5">
        <div class="accordion-text">
            <div class="fw-bold text-dark fs-1">FAQ</div>
            <ul class="faq-text">
            <li>
                <div class="question-arrow">
                <span class="question fw-bold">Apa itu aplikasi TerraScan?</span>
                <i class="fa-solid fa-chevron-down" style="color: #000000;"></i>
                </div>
                <p>TerraScan adalah sebuah aplikasi berbasis seluler yang memberikan solusi bagi para petani dan pemilik lahan dalam menganalisis tanah dengan cepat dan akurat. Pengguna dapat mengupload gambar tanah dan menginputkan parameter seperti tekstur, komposisi mineral, dan pH tanah, yang nantinya aplikasi akan memberikan rekomendasi jenis tanaman yang paling sesuai untuk ditanam di tanah tersebut.</p>
                <span class="line"></span>
            </li>
            <li>
                <div class="question-arrow">
                <span class="question fw-bold">Bagaimana cara mengunduh dan menginstal TerraScan?</span>
                <i class="fa-solid fa-chevron-down" style="color: #000000;"></i>
                </div>
                <p>Anda dapat mengunduh TerraScan dari toko aplikasi resmi, seperti Google Play Store untuk perangkat
                Android atau App Store untuk perangkat IOS.</p>
                <span class="line"></span>
            </li>
            <li>
                <div class="question-arrow">
                <span class="question fw-bold">Dapatkah TerraScan digunakan di desktop?</span>
                <i class="fa-solid fa-chevron-down" style="color: #000000;"></i>
                </div>
                <p>Ya, TerraScan tersedia dalam versi Mobile dan Desktop sehingga fleksibel untuk digunakan kapan saja dan di mana saja.</p>
                <span class="line"></span>
            </li>
            <li>
                <div class="question-arrow">
                <span class="question fw-bold">Apakah TerraScan memerlukan koneksi internet?</span>
                <i class="fa-solid fa-chevron-down" style="color: #000000;"></i>
                </div>
                <p>TerraScan memerlukan koneksi ke internet agar unggah gambar serta analisis dapat berjalan.</p>
                <span class="line"></span>
            </li>
            <li>
                <div class="question-arrow">
                <span class="question fw-bold">Bagaimana cara memulai analisis tanah menggunakan TerraScan?</span>
                <i class="fa-solid fa-chevron-down" style="color: #000000;"></i>
                </div>
                <p>Untuk melakukan analisis tanah, pertama pergi ke laman Analisis. Langkah selanjutnya adalah memilih gambar tanah yang ingin dianalisis.
                    Selanjutnya anda akan diminta memasukkan beberapa informasi tambahan seperti kota anda, iklim, pH tanah, dll sebagai informasi tambahan dalam analisis.
                    Selanjutnya klik mulai submit untuk memulai analisis dan tunggu hingga proses selesai. Setelah itu anda akan mendapatkan hasil analisis beserta rekomendasi tanaman yang sesuai.</p>
                <span class="line"></span>
            </li>
            </ul>
        </div>
