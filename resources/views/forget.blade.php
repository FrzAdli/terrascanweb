...
<body>
    ...
    <div class="login-page align-items-center">
        <div class="form-login">
            <p class="fw-bold fs-4 text-dark">Lupa Password?</p>
            <img src="{{ asset('assets/images/logo.svg') }}" alt="TerraScanTrans" style="height: 80px; width: 80px center; margin-top: 30px;">
            <br>
            <br>
            <form class="login-form" action="/sendmail" method="post">
                @csrf
                <label for="email" class="fw-bold primary-90">Email</label><br>
                <input type="text" class="mb-3" placeholder="Masukkan email akun anda" id="email" name="email" required>
                ...
                <button type="submit">Kirimkan tautan ubah password</button>
            </form>
            <p class="message text-center fw-bold">Kembali? <a href="{{ url('login') }}"> Masuk</a></p>
        </div>
    </div>
