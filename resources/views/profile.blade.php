  ...
  <body class="main-layout"> 
    ...
    <div class="container d-flex flex-column align-items-center mt-3">
        <div class="d-flex flex-column align-items-center text-center">
            <img style="border-radius: 50%; width: 150px; height: 150px;"  src="data:image/png;base64,{{ $user['imageProfile'] }}">
            <div class="mt-3">
                <a href="{{ url('/editprofile') }}" class="btn bg-primary-90 text-white mt-4" style="text-decoration: none;">Ubah Profil</a>
            </div>
        </div>
        <div class="row my-5"> 
            <div class="col-6">
                <label class="labels fw-bold primary-90 my-2" for="username">Username</label>
                <br>
                <label class="labels fw-bold primary-90 my-2" for="email">Email</label>
                <br>
                <label class="fw-bold primary-90 my-2" for="phoneNumber">Phone Number</label>
            </div>
            <div class="col-6">
                <label for="username" class="fw-bold neutral-70 my-2">{{ $user['username'] }}</label>
                <br>
                <label for="email" class="fw-bold neutral-70 my-2">{{ $user['email'] }}</label>
                <br>
                <label for="phoneNumber" class="fw-bold neutral-70 my-2">{{ $user['phoneNumber'] }}</label>
            </div>
        </div>
    </div>
