...
<html lang="en"> 
  ...
  <body class="main-layout"> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 ">
            <div class="text-bg">
              <h1>TerraScan</h1>
              <p>TerraScan adalah revolusi terbaru dalam dunia pertanian dan pengelolaan lahan, membawa kecerdasan buatan canggih untuk menganalisis jenis tanah secara lebih akurat dan efisien melalui gambar. Produk unggulan ini dikembangkan untuk memenuhi kebutuhan petani, insinyur pertanian, ilmuwan tanah, dan pengelola lahan dalam mengidentifikasi dan memahami karakteristik tanah dengan presisi.</p>
              <a href="{{ url('/analyze') }}">Mulai Analisis</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="about_section layout_padding container mt-5">
      <div class="container  ">
        <div class="row d-flex align-items-center m-3">
          <div class="col-6 ">
            <div class="detail-box">
              ...
              <p>
              Terrascan adalah platform analisis tanah yang memanfaatkan kecerdasan buatan untuk memberikan informasi mendalam tentang tanah Anda. Dirancang untuk kemudahan penggunaan melalui platform web, Terrascan membantu Anda memahami kondisi tanah dengan hanya mengunggah gambar.
              </p>
              <a href="{{ url('/about') }}">
                Lebih banyak
              </a>
          ...
          <div class="col-6 ">
            <div class="container">
              <div class="img-fluid text-center align-items-end mt-3">
    ...
    <section class="service_section layout_padding">
      <div class="container">
        <div class="heading_container">
          <h2 class="fs-1 fw-bold primary-60">
            Layanan Kami
          </h2>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 ">
            <a href="">
              <div class="box">
                <div class="img-box">
                  <img src="{{ asset('assets/images/CommunityIcon.svg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5 class="fw-bold">
                    Komunitas
          ...
          <div class="col-md-6 col-lg-3">
            <a href="{{ url('/analyze') }}">
              <div class="box">
                <div class="img-box">
                  <img src="{{ asset('assets/images/scanicon.svg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5 class="fw-bold">
                    Analisis
          ...
          <div class="col-md-6 col-lg-3">
            <a href="{{ url('/product') }}">
              <div class="box">
                <div class="img-box">
                  <img src="{{ asset('assets/images/shop.svg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5 class="fw-bold">
                    Produk
          ...
          <div class="col-md-6 col-lg-3">
            <a href="{{ url('/learn') }}">
              <div class="box">
                <div class="img-box">
                  <img src="{{ asset('assets/images/learnicon.svg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5 class="fw-bold">
                    Baca
      ...
      <div class="container">
        ...
        <div class="products">
          <div class="products-container">
            <?php
              shuffle($products);
              $randomProducts = array_slice($products, 0, 4);
            ?>
            @foreach ($randomProducts as $product)
              <div class="product" data-name="p-1">
                <a href="{{ route('product.show', ['productId' => $product['_id']]) }}">
                    <img src="data:image/png;base64,{{ $product['encodeProductImage'] }}" alt="">
                    <p class="productTitle">{{ $product['productName'] }}</p>
                    <p class="productInfo">Rp {{ $product['productPrice'] }}</p>
                    <p class="productInfo">{{ $product['seller_info'][0]['sellerLocation'] }}</p>
                </a>
              </div>
            @endforeach
          </div>
        </div>
        <a href="{{ url('/product') }}" class="primary-60 fw-bold fs-5">Lihat semua produk</a>
      </div>
    </section>
    <!-- product section end -->
    ...
    <section class="service_section layout_padding">
      <div class="container">
        <div class="heading_container">
          <h2 class="fs-1 fw-bold primary-60">
            Dapatkan Layanan Kami di Android
          </h2>
        </div>
        <div class="row">
          <div class="col-6">
            <img src="{{ asset('assets/images/mockupandroid.png') }}" class="img-fluid w-50">
          </div>
          <div class="col-6">
            <div class="row">
              <div class="col-md-12">
                <img src="{{ asset('assets/images/icon.png') }}" class="img-fluid w-50">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-md-12">
                <img src="{{ asset('assets/images/TerraScan.svg') }}" class="img-fluid w-50">
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-md-12">
                <img src="{{ asset('assets/images/googleplay.png') }}" class="img-fluid w-50">
              </div>
            </div>
          </div>
        </div>
