                ...
                <form action="/addproduct" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row py-5">
                        <div class="col-md-6 text-center">
                            <img src="{{ asset('assets/images/defaultUpload.png') }}" id="previewImage" class="img-fluid rounded float-right img-thumbnail productimg">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-left text-dark fw-bold">
                                ...
                                <textarea name="productDesc" class="form-control" rows="8" cols="50"></textarea>
                            </p>
                            <br>
                            <p class="text-left text-dark fw-bold">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-green hover-primary-10 text-light">Tambah Produk</button>
                    </div>
                </form>
